			...
			<div className="bg-black top-0 left-0 w-full z-5 flex flex-col items-center justify-center">
				<div
					className={`min-h-screen flex-1 flex flex-col items-center justify-center transform transition-transform duration-700 ${
						showWelcome ? 'translate-y-0 opacity-100' : '-translate-y-60 opacity-40'
					}`}
				>
					<h2 className="text-6xl font-bold text-white">WELCOME HONOURED GUEST</h2>
					<p className="p-4 text-lg text-white mt-4">to the birthplace of our dynasty</p>
					...
					<div className="flex">
						...
						<div className="p-8 text-center container">
							...
							<p className="text-lg text-white mt-4">
								Stay accountable by tracking and managing your Habits, Daily goals, and To-Do list with
								our web app.
							</p>
						</div>
						...
						<div className="p-8 text-center container">
							...
							<p className="text-lg text-white mt-4">
								Fight monsters with other Habiticans! Use the Gold that you earn to buy in-game or
								custom rewards, like watching an episode of your favorite TV show.
							</p>
						</div>
					</div>
				</div>
